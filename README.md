...
**Languages:** JavaScript, TypeScript, Java, Python, C#, C, HTML, CSS  
**Frontend:** React.js, Next.js, Tailwind CSS  
**Backend:** Node.js, Express.js, ASP.NET MVC  
**Databases & Tools:** MySQL, PostgreSQL, GraphQL, Git, TablePlus  
**CMS / Platforms:** Storyblok, Strapi, Kentico  
...
- Building cleaner full-stack projects with better documentation
- Improving backend API design and database modelling
- Practising data structures and algorithms
- Learning production-ready software engineering practices
